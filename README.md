...
plot_affect_gene(data=test_upload, data_source="Upload", go_enrichment=FALSE) # If go_enrichment is TRUE, the dotplot generated by analyze_gene_go() is returned as well
dev.off()
```
