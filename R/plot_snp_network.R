...
plot_snp_network <- function(snp, input_type = "rsID", colors="default"){
  ...
  eqtl_info <- get_snp_eqtl(snp, eqtl_tissue = "Whole_Blood")
  ...
  nodes_eqtl_tissue <- eqtl_info$tissueSiteDetailed
